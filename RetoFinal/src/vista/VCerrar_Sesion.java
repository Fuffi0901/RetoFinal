...
public class VCerrar_Sesion extends JDialog implements ActionListener{
	...
	public void pantalla(Dao dao) {
		...
		btnAtras.addActionListener(this);
			...
			pFConstrasena.setFont(new Font("Imprint MT Shadow", Font.PLAIN, 21));
			pFConstrasena.setForeground(new Color(255, 255, 255));
			pFConstrasena.setOpaque(false);
			pFConstrasena.setBorder(border);
			pFConstrasena.setBounds(941, 326, 275, 31);
			contentPanel.add(pFConstrasena);
			
			
			
	        
			rbMostrarConstrasena = new JRadioButton();
			rbMostrarConstrasena.setOpaque(false);
			rbMostrarConstrasena.setBounds(1202, 363, 28, 31);
			rbMostrarConstrasena.addItemListener(new ItemListener(){
				public void itemStateChanged(ItemEvent e) {
					mostrarConstrasena();
				}
			});
			contentPanel.add(rbMostrarConstrasena);
	...
	private void cogerUsuario() {
		...
		usu.setConstrasena(u.getConstrasena());
	}
	...
	private void modificarUsu() {
		...
		if(validar()) {
			...
			usuario.setConstrasena(pFConstrasena.getText());
	...
	private boolean validar() {
		...
		if(pFConstrasena.getText().isEmpty()) {
			bien=false;
			pFConstrasena.setBorder(border);
		}
		...
		if(bien) {
			...
			pFConstrasena.setBorder(bordernormal);
		}else {
	...
	private void cargarDatos() {
		...
		pFConstrasena.setText(usu.getConstrasena());
	}
