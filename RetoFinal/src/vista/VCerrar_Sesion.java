...
public class VCerrar_Sesion extends JDialog implements ActionListener{
	...
	public void pantalla(Dao dao) {
		...
		contentPanel.setLayout(null);
		{
			...
			lbTitulo.setBounds(56, 35, 657, 88);
		...
		btnAtras.addActionListener(this);
			...
			textApellido.setBounds(400, 331, 275, 31);
			...
			textNombreUsuario.setFont(new Font("Imprint MT Shadow", Font.PLAIN, 19));
			...
			pFConstraseña.setFont(new Font("Imprint MT Shadow", Font.PLAIN, 19));
