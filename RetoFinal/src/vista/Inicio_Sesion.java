...
public class Inicio_Sesion extends JFrame implements ActionListener{
	...
	public Inicio_Sesion (VBuscar vBuscar, boolean modal) {
		Pantallas();
	}
	
	public Inicio_Sesion (VRegistrarse vRegistrarse, boolean modal) {
		Pantallas();
	}
	
	public Inicio_Sesion (VPrincipal vPrincipal, boolean modal) {
		Pantallas();
	}
	
	public Inicio_Sesion (VCerrar_Sesion vCerrar_Sesion, boolean modal) {
		Pantallas();
	}
