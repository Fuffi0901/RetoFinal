...
public class VverArtista extends JDialog implements ActionListener{
	...
	public VverArtista(VPrincipal vPrincipal, boolean b, Dao dao, Artista art) {
		...
		this.setModal(b);
		cogerArtista();
		canciones = dao.sacarCancionesOrdenadas(art.getDni());
		...
		lbTitulo.setBounds(10, 63, 657, 88);
		...
		lblNewLabel.setBounds(20, 130, 647, 46);
		...
		lblNewLabel_1.setBounds(20, 186, 468, 46);
		...
		lblNewLabel_2_1.setBounds(332, 218, 271, 62);
	...
	private void cancionAleatoria() {
		...
		this.dispose();
		VentanaPlay ven = new VentanaPlay(this, numero, true, dao, canciones);
		ven.setVisible(true);
	...
	private void cogerArtista() {
	 ...
	 protected void escucharCancion() {
	     ...
	     this.dispose();
	     VentanaPlay play = new VentanaPlay(this, num,true, dao,canciones);
